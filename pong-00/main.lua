...
function love.update(dt)
    ...
    -- Hmmm, I'm not sure if I can beat this thing anymore...
    if gameState == 'serve' and math.abs(player1.y-ball.y) < 10 then
        player1.dy = 0
    ...
    if math.abs(player1.y - ball.y) > (VIRTUAL_HEIGHT * 0.05)  then
        player1.dy = player1.dy * 10
    end
